(function(){
  const themes={
    default:{label:'Default',body:'#f4f7fb',surface:'#ffffff',ink:'#12263f',muted:'#64748b',accent:'#0b6b5b',accent2:'#183a60',line:'#dce5ef'},
  ...
  function applyTheme(k){
    const x=themes[k]||themes.default;k=themes[k]?k:'default';
  ...
  function themeSwitcher(){
    ...
    document.body.appendChild(host);const s=host.querySelector('select');s.value=localStorage.getItem('hcPortalTheme')||'default';s.onchange=()=>applyTheme(s.value);
  }
  ...
  applyTheme(localStorage.getItem('hcPortalTheme')||'default');
